...
public class Busan3Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_busan3);

        //화면확대
        final View v = ((LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.activity_busan3, null, false);
    ...
    public void onCLickNext(View view) {
        Intent intent = new Intent(getApplicationContext(), Busan4Activity.class);
